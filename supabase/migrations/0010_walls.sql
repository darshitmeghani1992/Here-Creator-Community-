-- ════════════════════════════════════════════════════════════════════════════
-- 0010 · "The Wall" (Social Wall) — schema, RLS, triggers, realtime.
--
-- Introduces the Wall/Mark domain for the native Expo app. Reuses the same
-- Supabase project as the web app; adds NEW tables only (does not touch the
-- existing creators/rooms/messages/… tables). Safe to re-run (idempotent).
-- ════════════════════════════════════════════════════════════════════════════
